...
class LocalStorageService(context: Context) {
    ...
    suspend fun saveChatMessage(chatMessage: ChatMessage, conversationId: String): Long {
        return dataRepository.insertChatMessage(chatMessage)
    }
    
    suspend fun saveChatMessages(chatMessages: List<ChatMessage>, conversationId: String) {
